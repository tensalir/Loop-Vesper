...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "sessions_project_is_private_idx" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "generations_session_status_created_idx" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "generations_completed_idx" 
  ON "generations"("session_id", "created_at" DESC)
  WHERE "status" = 'completed';

-- Outputs: index for finding latest image outputs efficiently
CREATE INDEX CONCURRENTLY IF NOT EXISTS "outputs_generation_type_created_idx" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "outputs_images_idx" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "projects_updated_id_idx" 
