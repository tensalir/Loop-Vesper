  ...
  try {
    ...
    const data = iterations.map((iteration) => ({
      ...
      parameters: {
        ...
        sourceRootOutputId: iteration.parameters?.sourceRootOutputId,
        sourceKind: iteration.parameters?.sourceKind,
        sourceVideoOutputId: iteration.parameters?.sourceVideoOutputId,
        sourceTimecodeMs: iteration.parameters?.sourceTimecodeMs,
        sourceLabel: iteration.parameters?.sourceLabel,
      },
